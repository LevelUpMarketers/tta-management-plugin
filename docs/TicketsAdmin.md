...
Use the arrow at the end of each row to expand and edit individual ticket types. The **Manage Tickets** panel includes **Add New Ticket** and **Export All Attendees** actions so staff can append ticket types or download attendee data for the selected event. The export downloads a CSV with **First Name**, **Last Name**, and **Email** for every attendee across all ticket types.
