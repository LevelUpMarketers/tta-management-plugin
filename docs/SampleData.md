...
The plugin bundles development data for testing. From the **TTA Settings** admin page you can load a few fake upcoming events and matching tickets. Each sample event is created the same way as a normal event including its WordPress page so calendar links work.
