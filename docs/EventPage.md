...
scrolling. The wrapper column stretches to match the main content height so the
sticky ad behaves properly. The event details sidebar appears on the left with
